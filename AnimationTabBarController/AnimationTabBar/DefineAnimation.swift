...
struct DefineAnimation {
    
    static func fade(_ type: TransitionViewType, min: CGFloat = 0, max: CGFloat = 1) -> CAAnimation {
    ...
    static func scale(_ type: TransitionViewType, min: CGFloat = 0, max: CGFloat = 1) -> CAAnimation {
    ...
    static func move(_ type: TransitionViewType, direction: Direction, bounceValue: CGFloat = 30) -> CAAnimation {
